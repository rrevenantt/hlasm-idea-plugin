 ...
 */
public class HlasmCommenter implements IndentedCommenter,SelfManagingCommenter<CommenterDataHolder> {
    @Nullable
    @Override
...
///////////////////////////////////////////////////////////////////////
    ...
    public void commentLine(int line, int offset, @NotNull Document document, @NotNull CommenterDataHolder data) {
        int commentStartOffset = document.getLineStartOffset(line);
    ...
    public boolean isLineCommented(int line, int offset, @NotNull Document document, @NotNull CommenterDataHolder data) {
        return document.getText().charAt(document.getLineStartOffset(line))=='*';
    }
